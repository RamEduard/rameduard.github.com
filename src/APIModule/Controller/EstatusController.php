...
class EstatusController 
{
    ...
    function index(App $app)
    {
        ...
        $rows = Estatus::getInstance($db)->getAll();
    ...
    function create(App $app)
    {
    	...
    	if("POST" == $app['request']->getMethod()) {
            ...
            // Affected rows
            $affectedRows = Estatus::getInstance($db)->insert($data);
    ...
    function edit(App $app, $id)
    {
        ...
        if ("POST" == $app['request']->getMethod() || "PUT" == $app['request']->getMethod()) {
            ...
            // Affected rows
            $affectedRows = Estatus::getInstance($db)->update($data);
    ...
    function delete(App $app, $id)
    {
        ...
        if("DELETE" == $app['request']->getMethod()) {
            // Affected rows
            $affectedRows = Estatus::getInstance($db)->delete($id);
