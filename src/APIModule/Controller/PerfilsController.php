...
/**
 * Description of PerfilsController
 *
...
class PerfilsController 
{
    ...
    function index(App $app)
    {
        ...
        $rows = Perfils::getInstance($db)->getAll();
    ...
    function create(App $app)
    {
    	...
    	if("POST" == $app['request']->getMethod()) {
            ...
            // Affected rows
            $affectedRows = Perfils::getInstance($db)->insert($data);
    ...
    function edit(App $app, $id)
    {
        ...
        if ("POST" == $app['request']->getMethod() || "PUT" == $app['request']->getMethod()) {
            ...
            // Affected rows
            $affectedRows = Perfils::getInstance($db)->update($data);
    ...
    function delete(App $app, $id)
    {
        ...
        if("DELETE" == $app['request']->getMethod()) {
            // Affected rows
            $affectedRows = Perfils::getInstance($db)->delete($id);
