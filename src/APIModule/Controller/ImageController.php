...
class ImageController 
{
    ...
    function index(App $app)
    {
        ...
        $rows = Image::getInstance($db)->getAll();
    ...
    function create(App $app)
    {
    	...
    	if("POST" == $app['request']->getMethod()) {
            ...
            // Affected rows
            $affectedRows = Image::getInstance($db)->insert($data);
    ...
    function edit(App $app, $id)
    {
        ...
        if ("POST" == $app['request']->getMethod() || "PUT" == $app['request']->getMethod()) {
            ...
            // Affected rows
            $affectedRows = Image::getInstance($db)->update($data);
    ...
    function delete(App $app, $id)
    {
        ...
        if("DELETE" == $app['request']->getMethod()) {
            // Affected rows
            $affectedRows = Image::getInstance($db)->delete($id);
